...
class documents(models.Model):
    ...
    doc_detsigeffect = models.BooleanField(default=False,blank=True)
    doc_detnotsigeffect = models.BooleanField(default=False,blank=True)
    doc_deteir = models.BooleanField(default=False,blank=True)
    doc_detnegdec = models.BooleanField(default=False,blank=True)
    doc_detmitigation = models.BooleanField(default=False,blank=True)
    doc_detnotmitigation = models.BooleanField(default=False,blank=True)
    doc_detconsider = models.BooleanField(default=False,blank=True)
    doc_detnotconsider = models.BooleanField(default=False,blank=True)
    doc_detfindings = models.BooleanField(default=False,blank=True)
    doc_detnotfindings = models.BooleanField(default=False,blank=True)
    doc_eiravailableat = models.TextField(null=True,blank=True)
    doc_exministerial = models.BooleanField(default=False,blank=True)
    doc_exdeclared = models.BooleanField(default=False,blank=True)
    doc_exemergency = models.BooleanField(default=False,blank=True)
    doc_excategorical = models.BooleanField(default=False,blank=True)
    doc_exstatutory = models.BooleanField(default=False,blank=True)
    ...
    doc_nodbylead = models.NullBooleanField()
    doc_nodbyresp = models.NullBooleanField()
    ...
    doc_pending = models.BooleanField(default=False)
    doc_visible = models.BooleanField(default=False)
    doc_review = models.BooleanField(default=False)
    doc_plannerregion = models.IntegerField(null=True,blank=True)
    doc_plannerreview = models.NullBooleanField()
    doc_exstatus = models.IntegerField(null=True)
    ...
    doc_bia = models.NullBooleanField()
    doc_statewide = models.NullBooleanField()
...
class leadagencies(models.Model):
    ...
    lag_sch_no = models.CharField(max_length=10,null=True)
    lag_updated = models.DateField()
    lag_acronym = models.CharField(max_length=10)
    lag_disable = models.BooleanField(default=False)
...
class projects(models.Model):
    ...
    prj_pending = models.BooleanField(default=False)
    prj_visible = models.BooleanField(default=False)
